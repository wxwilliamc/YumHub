...
const Homepage = () => {
  return (
    <div className="flex flex-col gap-12">
        <div className="bg-white rounded-lg shadow-md py-8 flex flex-col gap-5 text-center -mt-32">
        ...
        <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className='flex flex-col items-center justify-center gap-4 text-center bg-orange-50 rounded-xl'>
